#ifndef StepperMotorStanda_H
#define StepperMotorStanda_H
...
/**
* \class StepperMotorStanda
*
* Author: Martin Spangenberg
* Contact: m.spangenberg.1@warwick.ac.uk
*/
class StepperMotorStanda: public Tool {


 public:

  StepperMotorStanda(); ///< Simple constructor
