#ifndef StepperMotorArduinoDummy_H
#define StepperMotorArduinoDummy_H
...
/**
* \class StepperMotorArduinoDummy
*
* Author: Martin Spangenberg
* Contact: m.spangenberg.1@warwick.ac.uk
*/

class StepperMotorArduinoDummy: public Tool {

 public:

  StepperMotorArduinoDummy(); ///< Simple constructor
